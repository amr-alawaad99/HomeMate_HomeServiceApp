    ...
    return BlocConsumer<LayoutCubit, LayoutStates>(
      listener: (context, state) {
        if(state is VerificationCodeSentSuccessState){
          ...
          navigateAndPush(context, widget: VerificationScreen(state.verificationId));
        }
      },
                                ...
                                widget: Dialog(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        SizedBox(height: 10,),
                                        Text("Your phone number is not verified!", textAlign: TextAlign.center),
                                        TextButton(
                                          onPressed: () {
                                            cubit.sendOTP();
                                          },
                                          child: Text("Click here to verify your phone number"),
                                        ),
                                      ],
                                    ),
                                  ),
                              ...
                              onPressed: () {
                                navigateAndPush(context,
                                  widget: Dialog(
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text("Your phone number is verified"),
                                    ),
                                  ),
                                );
                              },
