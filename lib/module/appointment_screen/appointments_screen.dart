...
class AppointmentsScreen extends StatelessWidget {
                ...
                builder: (context) => Padding(
                  ...
                  child: SizedBox(
                    child: ListView.separated(
                      ...
                      shrinkWrap: true,
                      itemBuilder: (context, index) => defaultAppointmentCard(model: cubit.myOrders[index], context: context),
                      separatorBuilder: (context, index) => const SizedBox(
                        height: 15,
                      ),
  ...
  Widget defaultAppointmentCard({required OrderModel model, required context}) => Container(
                  ...
                  Row(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(5),
                        child: Image(
                          image: NetworkImage("https://img.freepik.com/free-vector/self-care-concept_23-2148523717.jpg?w=740&t=st=1678538562~exp=1678539162~hmac=a7d5a1db32b0d9a70e2ebbf68ab260a7ff455a23edb61284689ea8c3559233dd"),
                          width: 30,
                          height: 30,
                        ),
                      ),
